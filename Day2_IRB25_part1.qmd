...
iris_dt[Sepal.Length < 6.7 & Petal.Length < 1.2 & Species != "setosa"]
```
...
unique(iris_dt$Species)

iris_dt[Species == "setosa" | Species == "versicolor"]

iris_dt[Species %in% c("versicolor", "setosa")]
...
#
vec_col <- c("Species", "Sepal.Width")
iris_dt[Sepal.Width == 3, ..vec_col]
```
